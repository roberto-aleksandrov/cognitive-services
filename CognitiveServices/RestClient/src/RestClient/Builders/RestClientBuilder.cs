namespace RestClient.Builders
{
    ...
    public class RestClientBuilder 
    {
        ...
        private Action<HeadersBuilder> _defaultHeaders;
        ...
        public IRestClient Build()
        {
            ...
            _defaultHeaders = _defaultHeaders ?? (x => {  });
        ...
        public RestClientBuilder WithDefaultHeaders(Action<HeadersBuilder> builder)
        {
            _defaultHeaders = builder;
            return this;
        }
